"""
SAHI Inference Script - Baseline Model
Slicing Aided Hyper Inference for improved small object detection
Uses baseline YOLOv8x model trained on aerial dataset
"""
import os
import argparse
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='SAHI Inference with Baseline YOLOv8x Model',
    ...
    parser.add_argument('--output', type=str, default='runs/sahi/baseline',
...
def setup_model(args):
    ...
    print(f"\n{'='*80}")
    print("BASELINE MODEL + SAHI INFERENCE")
    print(f"{'='*80}")
    print(f"\nModel: {args.model}")
